...
(function() {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    (function initWizard() {
      ...
      var CFG = {
        'Stocks & Shares ISA':       { cat: 'ISA',     bal: 'holdings', showEmployer: false, method: null, personalLabel: 'Monthly contribution', hint: 'How much do you put into this ISA each month? This feeds into projections. You can update it later.' },
        ...
        'Premium Bonds':              { cat: 'Savings', bal: 'premium_bonds', showEmployer: false, method: null, personalLabel: 'Monthly purchase', hint: 'How much do you usually add to Premium Bonds each month? Prize draws are tracked separately; projections use the planning rate.' },
      ...
      function applyConfig() {
        ...
        if (customRateHint) {
          customRateHint.textContent = w === 'Premium Bonds'
            ? 'Premium Bonds do not pay guaranteed interest. Use this as a planning assumption only; NS&I can change the prize fund rate.'
