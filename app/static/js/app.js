...
(function() {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    (function initWizard() {
      ...
      var CFG = {
        'Stocks & Shares ISA':       { cat: 'ISA',     bal: 'holdings', showEmployer: false, method: null, personalLabel: 'Monthly contribution', hint: 'How much do you put into this ISA each month? This feeds into projections — an estimate is fine.' },
