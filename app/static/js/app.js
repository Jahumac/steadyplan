  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    (function initWizard() {
      ...
      var CFG = {
        ...
        'SIPP':                       { cat: 'Pension', bal: 'holdings', showEmployer: false, method: null, personalLabel: 'Your monthly contribution', hint: 'How much do you pay in? Your provider claims 25% tax relief from HMRC automatically.' },
